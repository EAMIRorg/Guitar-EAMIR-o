# Contributing to Guitar EAMIR-o
...
This allows us to distribute Guitar EAMIR-o under its open-source license and to maintain the project without legal ambiguity.

We can offer both open-source and commercial licenses.
Guitar EAMIR-o is available under the AGPLv3, and we may also offer commercial licenses to developers who need to build proprietary applications. The CLA makes this possible while keeping the open-source version available to everyone.

WHAT THE CLA DOES NOT DO

It does not affect music, audio, or other creative works you create using Guitar EAMIR-o.
Anything you compose, record, or produce with the software is entirely yours.

It does not restrict your ability to fork, modify, or use Guitar EAMIR-o under its open-source license.
...
The CLA helps us keep Guitar EAMIR-o open, usable, and sustainable for the long term — for researchers, musicians, developers, and commercial users alike.
